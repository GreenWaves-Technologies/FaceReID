...
from torchreid.models.proxyless.layers import *
...
class ProxylessNASNets(BasicUnit):
    ...
    def __init__(self, first_conv, blocks, feature_mix_layer, classifier, loss):
    ...
    @staticmethod
    def build_from_config(config, num_classes, loss):
        first_conv = set_layer_from_config(config['first_conv'])
        feature_mix_layer = set_layer_from_config(config['feature_mix_layer'])
        config['classifier']['out_features'] = num_classes
        classifier = set_layer_from_config(config['classifier'])
        blocks = []
        for block_config in config['blocks']:
            blocks.append(MobileInvertedResidualBlock.build_from_config(block_config))

        return ProxylessNASNets(first_conv, blocks, feature_mix_layer, classifier, loss)
